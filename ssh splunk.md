...
Pull requests are welcome! If you have additional SPL queries, dashboard panels, or alert rules, feel free to open a PR.
 
---
 
*Built for blue teamers, SOC analysts, and anyone learning SIEM-based threat detection.*
